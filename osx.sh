...
sudo scutil --set ComputerName "eduardodeoh"
sudo scutil --set HostName "eduardodeoh"
sudo scutil --set LocalHostName "eduardodeoh"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "eduardodeoh"
